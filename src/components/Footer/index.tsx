          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col">
              ...
              <ul className="flex flex-col gap-4 text-[15px] font-medium">
                ...
                <li><Link href="/my-account" className="hover:underline">Dashboard</Link></li>
              </ul>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <ul className="flex flex-col gap-4 text-[15px] font-medium">
                ...
                <li><Link href="https://mightyolu.com/privacy-policy" target="_blank" rel="noopener noreferrer" className="hover:underline">Privacy And Policy</Link></li>
                <li><Link href="https://mightyolu.com/terms-and-condition" target="_blank" rel="noopener noreferrer" className="hover:underline">Terms And Conditions</Link></li>
              </ul>
            </div>
